 ...
 * ------------------------------------------------------------------------ */
 main( void )
{
    Int16 LEFT_DATA,RIGHT_DATA, sample,samplei,logic,a,b;
    Int16 sinetable_new[10];
    
    for (logic=0;logic<10;logic++){
    	if(logic>0)
    		{sinetable_new[logic] = 3000*(9-logic);}	
    	
    }
    sinetable_new[0] = 27000;
//    for (logic=0;logic<95;logic++)
//    {
//    	if(logic%2 == 0)
//    	{
//    		
//    		sinetable_new[logic] = sinetable[(logic/2)];	
//    	}
//    	else
//    	{
//    		a = logic-1;
//    		b = logic+1;
//    		sinetable_new[logic] = (sinetable[a/2]/2 + sinetable[b/2]/2);
//    	}
//    }
//    sinetable_new[95] = (sinetable[47]+sinetable[0])/2;
    /* Initialize BSL */
    SYS_EXBUSSEL = 0x6100;
    USBSTK5515_init( );
    AIC3204_config(freq_24);
	    ...
	    for(sample=0;sample<10;sample++)
			{
				...
				I2S0_W0_MSW_W=(sinetable_new[sample]);
				I2S0_W1_MSW_W=(sinetable_new[sample]);
