...
void tone(Int16 wavelength1, Int16 cycles);
...
void tone(Int16 frequency1,Int16 cycles)
{
	int i,j,max,k;
	max = 30000;
    cycles = (frequency1/5)*2*cycles;
    frequency1 = 12000/frequency1;
    for (i=0;i<cycles;i++)
        {
            k = frequency1/2;
            for(j=0;j<k;j++)
 ...
 main( void )
{
    ...
    //int wavelength[7]={(12000/131),a1,a2,a3,a4,a5,a6};
